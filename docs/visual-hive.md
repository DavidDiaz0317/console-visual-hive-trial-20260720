...
- Scripts: test:e2e: npm run build && playwright test, test:e2e:a11y-compliance: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/a11y-compliance.spec.ts, test:e2e:all-compliance: playwright test --config e2e/compliance/compliance.config.ts, test:e2e:cache-compliance: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/card-cache-compliance.spec.ts, test:e2e:chromium: playwright test --project=chromium, test:e2e:debug: playwright test --debug, test:e2e:error-resilience: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/error-resilience.spec.ts, test:e2e:firefox: playwright test --project=firefox, test:e2e:headed: playwright test --headed, test:e2e:i18n-compliance: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/i18n-compliance.spec.ts, test:e2e:interaction-compliance: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/interaction-compliance.spec.ts, test:e2e:nightly-health: playwright test e2e/nightly/dashboard-health.spec.ts -c e2e/nightly/nightly.config.ts, test:e2e:perf: playwright test --config e2e/perf/perf.config.ts e2e/perf/dashboard-perf.spec.ts, test:e2e:perf:nav: playwright test --config e2e/perf/perf.config.ts e2e/perf/dashboard-nav.spec.ts, test:e2e:perf:ttfi: playwright test --config e2e/perf/perf.config.ts e2e/perf/all-cards-ttfi.spec.ts, test:e2e:report: playwright show-report, test:e2e:security-compliance: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/security-compliance.spec.ts, test:e2e:ui-compliance: playwright test --config e2e/compliance/compliance.config.ts e2e/compliance/card-loading-compliance.spec.ts, test:e2e:ui: playwright test --ui, test:e2e:ux-sweep: PLAYWRIGHT_BASE_URL=http://localhost:8080 PLAYWRIGHT_STORAGE_STATE=auth.json playwright test --config=e2e/user-flows/ux-scan.config.ts, test:e2e:webkit: playwright test --project=webkit, test:visual: playwright test --config e2e/visual/app-visual.config.ts, test:visual:browser-matrix: playwright test --config e2e/visual-login/browser-matrix.config.ts, test:visual:groundtruth: playwright test --config e2e/visual-login/intensive.config.ts --project=semantic-groundtruth, test:visual:live: playwright test --config e2e/visual-login/intensive.config.ts --project=semantic-groundtruth --grep @live-site, test:visual:macos-popup: playwright test --config e2e/visual-login/macos-popup.config.ts, test:visual:update: playwright test --config e2e/visual/app-visual.config.ts --update-snapshots
- Config files: web/playwright.config.ts
- Dependencies detected: @playwright/test
- Playwright scripts detected: test:e2e, test:e2e:a11y-compliance, test:e2e:all-compliance, test:e2e:cache-compliance, test:e2e:chromium, test:e2e:debug, test:e2e:error-resilience, test:e2e:firefox, test:e2e:headed, test:e2e:i18n-compliance, test:e2e:interaction-compliance, test:e2e:nightly-health, test:e2e:perf, test:e2e:perf:nav, test:e2e:perf:ttfi, test:e2e:report, test:e2e:security-compliance, test:e2e:ui-compliance, test:e2e:ui, test:e2e:ux-sweep, test:e2e:webkit, test:visual, test:visual:browser-matrix, test:visual:groundtruth, test:visual:live, test:visual:macos-popup, test:visual:update
- Config files detected: web/playwright.config.ts
...
- Build command: npm --prefix web run build-storybook
- Serve command: npm --prefix web run storybook -- --host 127.0.0.1 --port 6006
- Setup commands: none
- Services: none
...
### storybook-ui-accessiblestatus-all-sizes-visual-stability

- Target: componentLibrary
- Selectors: body
- Screenshots: ui-accessiblestatus-all-sizes-desktop /iframe.html?id=ui-accessiblestatus--all-sizes&viewMode=story@desktop, ui-accessiblestatus-all-sizes-mobile /iframe.html?id=ui-accessiblestatus--all-sizes&viewMode=story@mobile
- Reasons: Detected Storybook story UI/AccessibleStatus in web/src/components/ui/AccessibleStatus.stories.tsx; starter screenshots target /iframe.html?id=ui-accessiblestatus--all-sizes&viewMode=story., No exact story-owned selector was proven, so the starter Storybook contract uses body rather than borrowing a repository-wide app selector., Desktop and mobile Storybook screenshots give a PR-safe component visual lane without requiring Chromatic.

### storybook-ui-button-accent-visual-stability

- Target: componentLibrary
- Selectors: body
- Screenshots: ui-button-accent-desktop /iframe.html?id=ui-button--accent&viewMode=story@desktop, ui-button-accent-mobile /iframe.html?id=ui-button--accent&viewMode=story@mobile
- Reasons: Detected Storybook story UI/Button in web/src/components/ui/Button.stories.tsx; starter screenshots target /iframe.html?id=ui-button--accent&viewMode=story., No exact story-owned selector was proven, so the starter Storybook contract uses body rather than borrowing a repository-wide app selector., Desktop and mobile Storybook screenshots give a PR-safe component visual lane without requiring Chromatic.

### storybook-ui-cloudprovidericon-aks-visual-stability

- Target: componentLibrary
- Selectors: body
- Screenshots: ui-cloudprovidericon-aks-desktop /iframe.html?id=ui-cloudprovidericon--aks&viewMode=story@desktop, ui-cloudprovidericon-aks-mobile /iframe.html?id=ui-cloudprovidericon--aks&viewMode=story@mobile
- Reasons: Detected Storybook story UI/CloudProviderIcon in web/src/components/ui/CloudProviderIcon.stories.tsx; starter screenshots target /iframe.html?id=ui-cloudprovidericon--aks&viewMode=story., No exact story-owned selector was proven, so the starter Storybook contract uses body rather than borrowing a repository-wide app selector., Desktop and mobile Storybook screenshots give a PR-safe component visual lane without requiring Chromatic.

## Detected Route Hints

- /auth/callback (web/src/components/auth/__tests__/AuthCallback.contract.test.tsx, 1 occurrence)
- /auth/github (web/src/components/auth/Login.tsx, 1 occurrence)
- /auth/manifest/setup (web/src/components/auth/Login.tsx, 1 occurrence)

## Detected Storybook Stories

- web/src/components/ui/AccessibleStatus.stories.tsx: UI/AccessibleStatus -> /iframe.html?id=ui-accessiblestatus--all-sizes&viewMode=story
- web/src/components/ui/Button.stories.tsx: UI/Button -> /iframe.html?id=ui-button--accent&viewMode=story
- web/src/components/ui/CloudProviderIcon.stories.tsx: UI/CloudProviderIcon -> /iframe.html?id=ui-cloudprovidericon--aks&viewMode=story
- web/src/components/ui/ClusterBadge.stories.tsx: UI/ClusterBadge -> /iframe.html?id=ui-clusterbadge--all-sizes&viewMode=story
- web/src/components/ui/ClusterStatusBadge.stories.tsx: UI/ClusterStatusBadge -> /iframe.html?id=ui-clusterstatusbadge--all-states&viewMode=story
- web/src/components/ui/CodeBlock.stories.tsx: UI/CodeBlock -> /iframe.html?id=ui-codeblock--base-font&viewMode=story
- web/src/components/ui/CollapsibleSection.stories.tsx: UI/CollapsibleSection -> /iframe.html?id=ui-collapsiblesection--collapsed&viewMode=story
- web/src/components/ui/ConsoleAIIcon.stories.tsx: UI/ConsoleAIIcon -> /iframe.html?id=ui-consoleaiicon--all-sizes&viewMode=story
- web/src/components/ui/FeatureHintTooltip.stories.tsx: UI/FeatureHintTooltip -> /iframe.html?id=ui-featurehinttooltip--all-placements&viewMode=story
- web/src/components/ui/FlashingValue.stories.tsx: UI/FlashingValue -> /iframe.html?id=ui-flashingvalue--auto-updating&viewMode=story

## Existing Workflow Hints

- .github/workflows/_perf-regression-issue.yml: triggers=none, permissions=contents: read, Visual Hive=no. Review: references secrets
- .github/workflows/a11y-audit.yml: triggers=pull_request, permissions=pull-requests: write, Visual Hive=no
- .github/workflows/accm-history-update.yml: triggers=schedule, workflow_dispatch, permissions=none, Visual Hive=no. Review: references secrets
- .github/workflows/acmm-level-monitor.yml: triggers=schedule, workflow_dispatch, permissions=contents: read, Visual Hive=no. Review: references secrets
- .github/workflows/add-help-wanted.yml: triggers=none, permissions=issues: write, Visual Hive=no
- .github/workflows/ai-attribution.yml: triggers=pull_request, permissions=contents: read, Visual Hive=no
- .github/workflows/ai-fix.yml: triggers=pull_request_target, workflow_dispatch, permissions=contents: write, Visual Hive=no. Review: uses pull_request_target, references secrets
- .github/workflows/api-contract.yml: triggers=pull_request, workflow_dispatch, permissions=none, Visual Hive=no
- .github/workflows/assignment-helper.yml: triggers=none, permissions=issues: write, Visual Hive=no
- .github/workflows/auth-login-smoke.yml: triggers=schedule, workflow_dispatch, permissions=issues: write, Visual Hive=no
...
- Evidence: project=kubestellar-console, packageManager=npm, frameworks=react, storybook, vite, scripts=build, build-storybook, coverage:clean, coverage:report, dev, dev:coverage, lint, lint:baseline, lint:check, postbuild, preview, storybook, test, test:card-loading-state, test:card-registry, test:card-toolbar, test:card-wrapper, test:cluster-groups-forms, test:consistency, test:consistency:strict, test:coverage, test:drilldown-gaps, test:drilldown-views, test:e2e, test:e2e:a11y-compliance, test:e2e:all-compliance, test:e2e:cache-compliance, test:e2e:chromium, test:e2e:coverage, test:e2e:debug, test:e2e:error-resilience, test:e2e:firefox, test:e2e:fullstack, test:e2e:headed, test:e2e:i18n-compliance, test:e2e:interaction-compliance, test:e2e:nightly-health, test:e2e:perf, test:e2e:perf:nav, test:e2e:perf:ttfi, test:e2e:perf:ttfi:gate, test:e2e:report, test:e2e:security-compliance, test:e2e:ui, test:e2e:ui-compliance, test:e2e:ui-compliance:gate, test:e2e:ux-sweep, test:e2e:webkit, test:netlify-github-cluster, test:netlify-identity, test:netlify-missions-analytics, test:rewards-badge, test:ui, test:visual, test:visual:browser-matrix, test:visual:browser-matrix:compare, test:visual:groundtruth, test:visual:live, test:visual:macos-popup, test:visual:update, routes=3, playwright=present
...
- Command: none
- Evidence: contracts=3, selectors=65, screenshots=6
...
- Local screenshots per run: 6
- External screenshots per run by default: 6
- Estimated monthly external screenshots: 120
...
- [warning] Existing workflow uses pull_request_target. Do not execute untrusted PR code in that workflow. Evidence: .github/workflows/ai-fix.yml
- [warning] Existing pull_request workflow appears to reference secrets. Visual Hive PR lanes should stay secret-free. Evidence: .github/workflows/build-deploy.yml
- [warning] One or more existing workflows use pull_request_target; keep Visual Hive PR checks on pull_request.
